...
def eval(args):
    ...
    result_low = vae.generate(300,torch.tensor([modularity_label[0]]))
    result_middle = vae.generate(300,torch.tensor([modularity_label[1]]))
    result_high = vae.generate(300,torch.tensor([modularity_label[2]]))
